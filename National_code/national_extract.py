...
deflator = [100.738, 102.515, 104.15, 104.979, 106.487, 108.67, 111.175, 112.978] * 969
...
df9 = pd.read_csv('./National_sources/9.csv')
...
writer = pd.ExcelWriter('./National_sources/cleaned_data.xlsx')
...
writer = pd.ExcelWriter('./National_sources/cleaned_data_raw.xlsx')
